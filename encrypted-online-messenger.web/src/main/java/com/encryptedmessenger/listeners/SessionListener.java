package com.encryptedmessenger.listeners;
...
public class SessionListener implements HttpSessionListener, 
	...
	public void attributeReplaced(HttpSessionBindingEvent event) {
		System.out.println("Attribute is replaced in the session"+ "REPLACED name: " + event.getName() + "; REPLACED value: " + event.getValue());
	}
